...
def get_pretraining_cifar10_fedsimclr(data_dir, user_groups, idx):
...
def get_shadow_cifar10_each_malicious(args, attacker, attacker_count, usergroups):
