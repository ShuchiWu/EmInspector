...
class CIFAR10CUSTOMFed(Dataset):
...
class CIFAR10CUSTOMTest(Dataset):
...
class CIFAR10Pair(CIFAR10CUSTOMFed):
...
class CIFAR10Mem(CIFAR10CUSTOMTest):
...
class CIFAR10Pair_fltrust(CIFAR10Server):
