...
def get_pretraining_cifar100_fedsimclr(data_dir, user_groups, idx):
...
def get_shadow_cifar100_each_malicious(args, attacker, attacker_count, usergroups):
...
def get_server_data_cifar100(args):
    numpy_file = args.inspection_data_dir
    server_data = CIFAR10Pair_fltrust(numpy_file=numpy_file, class_type=classes, transform=train_transform)
    return server_data

def get_inspection_data_cifar100(data_dir):
